...
- A proof of concept fraud detection tool using machine learning implemented in R and RShiny (Part of PhD work). [Click Here](https://sssihlactuarialdatascience.shinyapps.io/frauddetection/) <br/>
    Tools used : 
